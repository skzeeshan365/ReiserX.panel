...
public class screenShotImageAdapter extends RecyclerView.Adapter<screenShotImageAdapter.SingleViewHolder> {
    ...
    @NonNull
    @Override
    public screenShotImageAdapter.SingleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recycler_view, parent, false);
        return new screenShotImageAdapter.SingleViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull screenShotImageAdapter.SingleViewHolder holder, int position) {
